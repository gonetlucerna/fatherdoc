...
import com.gonet.testconn.Medico;
 ...
 */
@Stateless
@Path("com.gonet.testconn.medico")
public class MedicoFacadeREST extends AbstractFacade<Medico> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	public void edit(@PathParam("id") String id, Medico entity) {
		super.edit(entity);
	}
	...
	public Medico find(@PathParam("id") String id) {
